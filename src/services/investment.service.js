...
class InvestmentService {
    buyAsset(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const checkCustody = yield AccountModel_1.default.findOne({ attributes: ['assetQuantity', 'userId', 'assetId',], where: { userId: payload.codCliente, assetId: payload.codAtivo } });
            if (checkCustody === null) {
                const newCustody = yield AccountModel_1.default.create({ userId: payload.codCliente, assetId: payload.codAtivo, assetQuantity: payload.qtdeAtivo, assetValue: retrieveAsset === null || retrieveAsset === void 0 ? void 0 : retrieveAsset.value });
                return newCustody;
            }
            // const newAssetQuantity = evaluate(`${retrieveAsset?.quantity} - ${payload.qtdeAtivo}`);
            yield AccountModel_1.default.update({ assetQuantity: (0, mathjs_1.evaluate)(`${checkCustody === null || checkCustody === void 0 ? void 0 : checkCustody.assetQuantity} + ${payload.qtdeAtivo}`) }, { where: { userId: payload.codCliente, assetId: payload.codAtivo } });
            ...
            return { userId: payload.codCliente, assetId: payload.codAtivo, assetQuantity: (0, mathjs_1.evaluate)(`${checkCustody === null || checkCustody === void 0 ? void 0 : checkCustody.assetQuantity} + ${payload.qtdeAtivo}`), assetvalue: retrieveAsset === null || retrieveAsset === void 0 ? void 0 : retrieveAsset.value };
        });
    }
}
